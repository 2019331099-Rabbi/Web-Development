...
// Determine the total price of the products
...
let votes = ['yes', 'no', 'yes', 'yes', 'yes', 'no', 'absent'];

// Count the number of yes no and absent
...
//     if (vote === 'yes') voteCounter.yes++;
//     else if (vote === 'no') voteCounter.no++;
//     else voteCounter.absent++;
// }
// console.log(voteCounter);


// Method 2
// let voteCounter = votes.reduce((acc, vote) => {
